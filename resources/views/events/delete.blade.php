            ...
            Denna bokning är återkommande. Välj vilka bokningar du vill ta bort.
                ...
                <div class="input">
                    <div class="radio">
                        ...
                        <label for="all">Ta bort alla bokningar i serien
                            (berör {{ $event->recurringEvents()->get()->count() }} bokningar)</label>
                    </div>
                    <div class="radio">
                        {!! Form::radio('recurring', 'following', false, ['id' => 'following']) !!}
                        <label for="following">Ta bort denna och alla efterföljande i serien
                            (berör {{ $event->followingRecurringEvents()->get()->count() }} bokningar)</label>
                    </div>
                    <div class="radio">
